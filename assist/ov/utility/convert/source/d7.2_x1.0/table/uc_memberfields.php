 ...
 * DiscuzX Convert
 *
 * $Id: uc_memberfields.php 10469 2010-05-11 09:12:14Z monkey $
 */

$curprg = basename(__FILE__);

$table_source = $db_source->tablepre.'uc_memberfields';
$table_target = $db_target->tablepre.'ucenter_memberfields';
$limit = $setting['limit']['uc_memberfields'] ? $setting['limit']['uc_memberfields'] : 2500;
$nextid = 0;
$nexttable = 0;
$start = getgpc('start');
if(empty($start)) {
