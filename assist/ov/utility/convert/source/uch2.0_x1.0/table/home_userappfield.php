 ...
 * DiscuzX Convert
 *
 * $Id: home_userappfield.php 10469 2010-05-11 09:12:14Z monkey $
 */

$curprg = basename(__FILE__);

$table_source = $db_source->tablepre.'userappfield';
$table_target = $db_target->tablepre.'home_userappfield';

$start = getgpc('start');
$start = empty($start) ? 0 : intval($start);
$limit = $setting['limit']['userapp'] ? $setting['limit']['userapp'] : 1000;
$nextid = $limit + $start;
$done = true;
